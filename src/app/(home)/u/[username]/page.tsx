...
export default async function User({ params }: {
    ...
    if (initialData?.error) {
        return <div className="text-center mt-[10vh] text-xl font-semibold">Error loading posts. Please try again.</div>;
    }
    return (
        <main className="">
            ...
            {!initialData.posts.length ? <div className="text-center mt-5 text-xl font-semibold">User has not posted anything.</div>
